...
<<<<<<< HEAD
* This function requires feature `json` to be activated. To enable this feature add to your `Cargo.toml`  dependencies the following line `edn-rs = { version = 0.16.0", features = ["json"] }`.
=======
* This function requires feature `json` to be activated. To enable this feature add to your `Cargo.toml`  dependencies the following line `edn-rs = { version = 0.15.1", features = ["json"] }`.
>>>>>>> 0e7ab7584f7345c21208d7c74618f71f1f95c079
...
<<<<<<< HEAD
Edn supports `futures` by using the feature `async`. To enable this feature add to your `Cargo.toml`  dependencies the following line `edn-rs = { version = 0.16.0", features = ["async"] }` and you can use futures as in the following example.
=======
Edn supports `futures` by using the feature `async`. To enable this feature add to your `Cargo.toml`  dependencies the following line `edn-rs = { version = 0.15.1", features = ["async"] }` and you can use futures as in the following example.
>>>>>>> 0e7ab7584f7345c21208d7c74618f71f1f95c079
...
- [x] Define EDN types, `EdnType`
    ...
    - [x] `to_debug()` for `Edn`.
<<<<<<< HEAD
- [x] Parse EDN data [`from_str`](https://docs.rs/edn-rs/0.16.0/edn_rs/deserialize/fn.from_str.html):
=======
- [x] Parse EDN data [`from_str`](https://docs.rs/edn-rs/0.15.1/edn_rs/deserialize/fn.from_str.html):
>>>>>>> 0e7ab7584f7345c21208d7c74618f71f1f95c079
    - [x] nil `""`
    - [x] String `"\"string\""`
...
<<<<<<< HEAD
- [ ] Simple data structures in one another [`edn!`](https://docs.rs/edn-rs/0.16.0/edn_rs/macro.edn.html):
=======
- [ ] Simple data structures in one another [`edn!`](https://docs.rs/edn-rs/0.15.1/edn_rs/macro.edn.html):
>>>>>>> 0e7ab7584f7345c21208d7c74618f71f1f95c079

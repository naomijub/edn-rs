...
* This function requires feature `json` to be activated. To enable this feature add to your `Cargo.toml`  dependencies the following line `edn-rs = { version = 0.13.5", features = ["json"] }`.
...
- [ ] Simple data structures in one another [`edn!`](https://docs.rs/edn-rs/0.13.5/edn_rs/macro.edn.html):

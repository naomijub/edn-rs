...
- [x] Parse EDN data [`parse_edn`](https://docs.rs/edn-rs/0.8.2/edn_rs/deserialize/fn.parse_edn.html):
    - [x] nil `""`
    - [x] String `"\"string\""`
...
- [ ] Simple data structures in one another [`edn!`](https://docs.rs/edn-rs/0.8.2/edn_rs/macro.edn.html):
